...
export const NOTIFICATION_TYPES = [
  ...
  'TASK_REQUEST_SUBMITTED', 'TASK_REQUEST_APPROVED', 'TASK_REQUEST_REJECTED', 'TASK_REQUEST_NEEDS_INFO',
...
export const NOTIFICATION_TYPE_LABELS: Record<NotificationType, string> = {
  ...
  TASK_REVIEW_REQUESTED: 'Task Submitted for Review',
  TASK_COMPLETED: 'Task Completed',
  TASK_SENT_BACK: 'Task Sent Back for Rework',
  TASK_REQUEST_SUBMITTED: 'Task Request Submitted',
  TASK_REQUEST_APPROVED: 'Task Request Approved',
  TASK_REQUEST_REJECTED: 'Task Request Rejected',
  TASK_REQUEST_NEEDS_INFO: 'Task Request Needs Information',
  EXTENSION_REQUESTED: 'Time Extension Requested',
  EXTENSION_APPROVED: 'Time Extension Approved',
  EXTENSION_DECLINED: 'Time Extension Declined',
  DELIVERABLE_SUBMITTED: 'Deliverable Submitted for Review',
  DELIVERABLE_APPROVED: 'Deliverable Approved',
  DELIVERABLE_REJECTED: 'Deliverable Returned for Rework',
  PROJECT_READY_TO_CLOSE: 'Project Ready to Close',
